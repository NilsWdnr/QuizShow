...
export default function Register (){
    ...
    const register = async (data) => {
        ...
        /* const body = Object.keys(data).reduce((params, key) => {
    ...
    if(userState.loggedIn===true){
        ...
        return(
            <div className="container-fluid px-3 register-wrapper">
                    ...
                    <div className="py-3 px-3 px-sm-5 my-5 col-11 col-lg-6 container-style-primary">
                        ...
                        <form className="my-4" onSubmit={handleSubmit} noValidate>
                            ...
                            <div className="form-group">
                                ...
                                <input type="password" className="form-control mb-3" id="password-repeat" value={passwordRepeat} onChange={handleChange}/>
